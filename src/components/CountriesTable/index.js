    ...
    return(
        <div className="countries-container">
            <div className="countries-header">
                ...
                <div onClick={() => getOrderCountries ('name')} className= {active === 'name' ? 'active' : ''}>
                    Name 
                </div>

                <div onClick={() => getOrderCountries ('capital')} className= {active === 'capital' ? 'active' : ''}>
                    Capital 
                </div>

                <div onClick={() => getOrderCountries ('population')} className= {active === 'population' ? 'active' : ''}>
                    Population 
                </div>

                <div onClick={() => getOrderCountries ('area')} className= {active === 'area' ? 'active' : ''}>
                    Area 
                </div>
            </div>
